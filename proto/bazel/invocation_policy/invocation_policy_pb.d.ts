...
// @generated from file proto/bazel/invocation_policy/invocation_policy.proto (package blaze.invocation_policy, syntax proto2)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message blaze.invocation_policy.InvocationPolicy
 */
export declare class InvocationPolicy extends Message<InvocationPolicy> {
  /**
   * @generated from field: repeated blaze.invocation_policy.FlagPolicy flag_policies = 1;
   */
  ...
  static readonly typeName = "blaze.invocation_policy.InvocationPolicy";
...
/**
 * @generated from message blaze.invocation_policy.FlagPolicy
 */
export declare class FlagPolicy extends Message<FlagPolicy> {
  ...
  /**
   * @generated from oneof blaze.invocation_policy.FlagPolicy.operation
   */
  operation: {
    /**
     * @generated from field: blaze.invocation_policy.SetValue set_value = 3;
     */
    value: SetValue;
    case: "setValue";
  } | {
    /**
     * @generated from field: blaze.invocation_policy.UseDefault use_default = 4;
     */
    value: UseDefault;
    case: "useDefault";
  } | {
    /**
     * @generated from field: blaze.invocation_policy.DisallowValues disallow_values = 5;
     */
    value: DisallowValues;
    case: "disallowValues";
  } | {
    /**
     * @generated from field: blaze.invocation_policy.AllowValues allow_values = 6;
     */
    value: AllowValues;
    case: "allowValues";
  ...
  static readonly runtime: typeof proto2;
  static readonly typeName = "blaze.invocation_policy.FlagPolicy";
  static readonly fields: FieldList;
...
/**
 * @generated from message blaze.invocation_policy.SetValue
 */
export declare class SetValue extends Message<SetValue> {
  ...
  /**
   * @generated from field: optional blaze.invocation_policy.SetValue.Behavior behavior = 4;
   */
  ...
  static readonly runtime: typeof proto2;
  static readonly typeName = "blaze.invocation_policy.SetValue";
  static readonly fields: FieldList;
...
/**
 * @generated from enum blaze.invocation_policy.SetValue.Behavior
 */
...
/**
 * @generated from message blaze.invocation_policy.UseDefault
 */
export declare class UseDefault extends Message<UseDefault> {
  constructor(data?: PartialMessage<UseDefault>);

  static readonly runtime: typeof proto2;
  static readonly typeName = "blaze.invocation_policy.UseDefault";
  static readonly fields: FieldList;
...
/**
 * @generated from message blaze.invocation_policy.DisallowValues
 */
export declare class DisallowValues extends Message<DisallowValues> {
  ...
  /**
   * @generated from oneof blaze.invocation_policy.DisallowValues.replacement_value
   */
  replacementValue: {
    /**
  ...
  static readonly runtime: typeof proto2;
  static readonly typeName = "blaze.invocation_policy.DisallowValues";
  static readonly fields: FieldList;
...
/**
 * @generated from message blaze.invocation_policy.AllowValues
 */
export declare class AllowValues extends Message<AllowValues> {
  ...
  /**
   * @generated from oneof blaze.invocation_policy.AllowValues.replacement_value
   */
  replacementValue: {
    /**
     * @generated from field: string new_value = 3;
  ...
  static readonly runtime: typeof proto2;
  static readonly typeName = "blaze.invocation_policy.AllowValues";
  static readonly fields: FieldList;
